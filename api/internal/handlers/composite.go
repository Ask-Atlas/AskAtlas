...
// AttachResource is a temporary stub satisfying the generated
// ServerInterface while the studyguides.Service.AttachResource method
...
func (h *CompositeHandler) AttachResource(w http.ResponseWriter, _ *http.Request, _ openapi_types.UUID) {
...
// DetachResource is a temporary stub satisfying the generated
// ServerInterface while the studyguides.Service.DetachResource method
// + the real StudyGuideHandler wiring land in follow-up commits.
// Removed when the embedded *StudyGuideHandler provides the real method.
func (h *CompositeHandler) DetachResource(w http.ResponseWriter, _ *http.Request, _ openapi_types.UUID, _ openapi_types.UUID) {
	apperrors.RespondWithError(w, &apperrors.AppError{
		Code:    http.StatusNotImplemented,
		Status:  "Not Implemented",
		Message: "Endpoint not yet implemented",
