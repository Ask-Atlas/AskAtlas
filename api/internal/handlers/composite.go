...
// UpdateStudyGuide is a temporary stub satisfying the generated
// ServerInterface while the studyguides.Service.UpdateStudyGuide method
...
func (h *CompositeHandler) UpdateStudyGuide(w http.ResponseWriter, _ *http.Request, _ openapi_types.UUID) {
