...
// CreateFileParams contains the validated inputs for creating a new
// file metadata record (ASK-105). S3Key is generated by the caller
// (typically the Next.js server) and stored as-is; the Go API does
// not validate it against S3.
