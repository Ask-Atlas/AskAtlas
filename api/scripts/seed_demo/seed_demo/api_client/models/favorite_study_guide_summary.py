...
T = TypeVar("T", bound="FavoriteStudyGuideSummary")


@_attrs_define
class FavoriteStudyGuideSummary:
    """Compact study-guide payload embedded in a FavoriteItem when
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        favorite_study_guide_summary = cls(
            id=id,
            title=title,
            course_department=course_department,
            course_number=course_number,
        ...
        favorite_study_guide_summary.additional_properties = d
        return favorite_study_guide_summary
