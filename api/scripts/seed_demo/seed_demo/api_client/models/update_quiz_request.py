...
T = TypeVar("T", bound="UpdateQuizRequest")


@_attrs_define
class UpdateQuizRequest:
    """Request body for PATCH /api/quizzes/{quiz_id}. Both fields
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_quiz_request = cls(
            title=title,
            description=description,
        )

        update_quiz_request.additional_properties = d
        return update_quiz_request
