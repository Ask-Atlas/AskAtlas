...
if TYPE_CHECKING:
    ...
    from ..models.section_summary import SectionSummary


T = TypeVar("T", bound="CourseDetailResponse")


@_attrs_define
class CourseDetailResponse:
    """A course with its school summary and the full list of sections
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sections_item_data in _sections:
            sections_item = SectionSummary.from_dict(sections_item_data)
        ...
        course_detail_response.additional_properties = d
        return course_detail_response
